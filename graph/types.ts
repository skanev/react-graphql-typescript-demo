...
export interface GetRepository_repository_repositoryTopics {
  ...
  nodes: (GetRepository_repository_repositoryTopics_nodes | null)[] | null;  // A list of nodes.
}
...
export interface GetRepository {
  repository: GetRepository_repository | null;  // Lookup a given repository by the owner and repository name.
}
...
export interface GetOrganizationQuery_organization_repositories {
  ...
  nodes: (GetOrganizationQuery_organization_repositories_nodes | null)[] | null;  // A list of nodes.
}
...
export interface GetOrganizationQuery {
  organization: GetOrganizationQuery_organization | null;  // Lookup a organization by login.
}
...
export interface StarRepositoryMutation {
  addStar: StarRepositoryMutation_addStar | null;  // Adds a star to a Starrable.
}
...
export interface UnstarRepositoryMutation {
  removeStar: UnstarRepositoryMutation_removeStar | null;  // Removes a star from a Starrable.
}
